=== WP Shorties ===
Contributors: softwarp,sugiartha
Donate link: 
Tags: url shortening, short url, urlshortener, click through tracking, affiliate link cloaker, link cloaking
...
Professional url shortener for click tracking and affiliate link cloaking
...
To see link cloaking in action and learn strategies how to use it best [visit our wordpress plugin blog](http://softwarp.com/portfolio-post/wp-shorties/ "WPShorties") today.
...
See http://softwarp.com/portfolio_post/wp_shorties/

= Need assistance? = 

Plugin support https://wordpress.org/support/plugin/wp-shorties


== Screenshots ==

1. List of all short url
2. WP Shorties logs
3. Options / configuration
4. WP Shorties usage notes
...
* Update wpshorties mysql table
* Add additional link parameters (nofollow, inline style, etc) 
* Replace insert and update mysql query using wpdb methods
* Use dbDelta to check & upgrade wpshorties mysql table 
* Move wpshorties menu to "Setting" menu
* Update submenu 'Documentation' to 'Usage Notes'
* Remove _print_doc method
* Remove _create_top_menu method
* Remove _check_db_field method 
* Add plugin setting link at plugin list 
* Add long_url field at wpshorties logs

= 2.95 =

* Detect WPMU & WP multi site.
